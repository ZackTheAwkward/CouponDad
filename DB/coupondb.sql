...
START TRANSACTION;
USE `coupondb`;
INSERT INTO `post` (`id`, `user_id`, `topic_id`, `title`, `content`, `image_url`, `active`, `create_date`, `update_date`) VALUES (1, 1, 1, 'Test Post', 'Test Test Test', NULL, 1, '2022-06-13', NULL);
...
START TRANSACTION;
USE `coupondb`;
INSERT INTO `comment` (`id`, `user_id`, `post_id`, `in_reply_to`, `content`, `create_date`, `active`) VALUES (1, 1, 1, NULL, 'Test', '2022-06-13', DEFAULT);
